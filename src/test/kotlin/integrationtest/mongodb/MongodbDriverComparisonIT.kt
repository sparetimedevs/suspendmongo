...
internal class MongodbDriverComparisonIT : StringSpec() {
	...
	init {
		...
		"Given five inserts at one moment when testing mongodb reactive streams driver and mongodb sync driver then reactive streams driver is faster" {
		...
		"Given two hundred and fifty inserts at one moment when testing mongodb reactive streams driver and mongodb sync driver then reactive streams driver is faster" {
